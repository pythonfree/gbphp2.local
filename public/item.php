...
<div class='goodsWrapItem'>
					...
					echo('<div class="stickerItem"><img class="stickerImgItem" src="css/star.png"><span class="stickerTextItem">'.$good['discount'].'%</span><div class="explain">    блюдо со скидкой дня '.$good['discount'].'%</div></div>');
				};
				if ($good['stickerFit']==1) {
					echo('<div class="stickerItem"><img class="stickerImgItem" src="css/star.png"><span class="stickerTextItem">Fit!</span> <div class="explain">     блюдо с низкой калорийностью</div></div>');
				};
				if ($good['stickerHit']==1) {
					echo('<div class="stickerItem"><img class="stickerImgItem" src="css/star.png"><span class="stickerTextItem">Hit!</span><div class="explain">    популярное блюдо</div></div>');
				};?>
					</div>
